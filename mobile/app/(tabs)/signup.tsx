      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.formContainer}>
          ...
          <View style={styles.checkboxContainer}>
            ...
            <Text style={styles.checkboxLabel}>I agree to the <Text style={styles.link} onPress={() => router.push('/terms')}>Terms of Service</Text></Text>
          </View>
          <View style={styles.checkboxContainer}>
            <Switch value={agreeToPrivacy} onValueChange={setAgreeToPrivacy} trackColor={{ false: "#767577", true: "#FF69B4" }} thumbColor={"#f4f3f4"} />
            <Text style={styles.checkboxLabel}>I agree to the <Text style={styles.link} onPress={() => router.push('/privacy')}>Privacy Policy</Text></Text>
          </View>
