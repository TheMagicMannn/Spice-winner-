-- =====================================================
-- EVENTS TABLE MIGRATION FIX (Version 2 - Fixed)
-- =====================================================
...
DROP INDEX IF EXISTS idx_events_future;
...
-- Recreate policies (date filtering will be done in application layer)
...
-- 
-- Note: Date filtering (future events only) is now handled in the 
-- application layer instead of the database policy, as CURRENT_DATE
-- cannot be used in immutable contexts.
-- 
-- Next steps:
